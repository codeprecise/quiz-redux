...
import { getAnswerStates, currentQuestion as currentQuestionHelper } from "./app.helpers";
...
export const currentQuestion = createSelector(
  root,
  state => currentQuestionHelper(state)
);

export const answerStates = createSelector(
  root,
  state => [...getAnswerStates(state)]
);
